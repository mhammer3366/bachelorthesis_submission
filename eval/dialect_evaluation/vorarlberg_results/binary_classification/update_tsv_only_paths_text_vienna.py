...
TSV_PATH = "/home/ai/AI-DataPool/Datasets/audio/Österreich/sliced_16000_mono/Wien/master_with_phonemes.with_client_duration_with_label_id_0_high_1_dialect.tsv"
...
def filter_tsv_in_place(tsv_path: str) -> None:
    ...
    try:
        ...
        if not wrote_any:
            print("No rows with label_id == 1 found. File now contains only header.", file=sys.stderr)
    finally:
